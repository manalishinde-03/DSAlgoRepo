...
public class DSAlgo_Home_SD {
	...
	public void user_is_able_to_see_all_options_in_data_structures_dropdown() {
		...
		List <WebElement> dsOptions = driver.findElements(By.xpath("//div/a[@class='dropdown-item']"));
	...
	public void user_clicks_register_link_and_navigates_to_register_page() {
		...
		WebElement registrationForm = driver.findElement(By.xpath("//form[@method='post']"));
	...
	public void user_clicks_sign_in_link_and_navigates_to_login_page() {
		...
		WebElement loginForm = driver.findElement(By.xpath("//form[@method='post']"));
	...
	@Then("user not logged in warning message should be displayed")
	public void user_not_logged_in_warning_message_should_be_displayed() {

		 driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(2));
		 String warningMsg = driver.findElement(By.xpath("//div[@class='alert alert-primary']")).getText();
